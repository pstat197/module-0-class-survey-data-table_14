...
author: "Justin Zhou, Ella Yang, Lucy Cao, Cecilia Jiang, Janice Jiang, Wendy Zhu (Equal Contribution)"
date: last-modified
...
-   **Measurements.** Demographics; self-assessed **proficiency** and **comfort** (Likert 1–5); indicators for prior coursework; and project preferences.
    -   For Q1, we use `stat.prof` (statistics proficiency; ordered beginner → intermediate → advanced) and `pstat_courses_total` (sum of PSTAT course indicators per student).
    -   For Q2, we use `prog.prof` (programming proficiency; ordered beginner → intermediate → advanced), `prog.comf` and `cs_total` (sum of CS course indicators per student, including `CS9`, `CS16`, `CS130`, `CS165`, `CS5`, and programming-intensive PSTAT courses such as `PSTAT100`, `PSTAT131`, and `PSTAT134`).
...
# Part 2: How will the number of Computer Science courses that a student takes affects the students' programming proficiency?
...
### Relationship Between CS Coursework and Programming Proficiency
...
### Distribution of Programming Confidence by Proficiency Level
...
### Linear Relationship between Number of CS Courses and Programming Proficiency
